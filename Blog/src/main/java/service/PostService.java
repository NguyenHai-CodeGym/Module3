...
public class PostService implements IPost {
    ...
    public void insert(Post data) throws SQLException {
        try(PreparedStatement statement = connection.getConnection().prepareStatement(INSERT_POST)) {
    ...
    try(PreparedStatement statement = connection.getConnection().prepareStatement(UPDATE_POST))
    {
        statement.setString(1, data.getTitle());
        statement.setString(2, data.getFullContent());
        statement.setString(3, data.getShortContent());
    ...
    public void delete(int id) {
        try(PreparedStatement statement = connection.getConnection().prepareStatement(DELETE)) {
    ...
    public Post findByID(int data) {
        Post post = new Post();
        try(PreparedStatement statement = connection.getConnection().prepareStatement(FINDBYID)) {
